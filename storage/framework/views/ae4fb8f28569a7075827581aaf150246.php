  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<style type="text/css">
			...
			.authlogin-side-wrapper{
				width: 100%;
				height: 100%;
				background-image: url(<?php echo e(asset('upload/login.png')); ?>);
			}
	</style>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Royal<span>Estate </span></a>
                    <h5 class="text-muted fw-normal mb-4">Welcome back! Log in to your account.</h5>


     <form class="forms-sample" method="post" action="<?php echo e(route('login')); ?>">
       <?php echo csrf_field(); ?>
...
</html><?php /**PATH /Users/aurabhattacharyya/Documents/localhost/xamppfiles/htdocs/laravelbackup/realestate/resources/views/admin/admin_login.blade.php ENDPATH**/ ?>