...
<!-- Stylesheets -->
<link href="<?php echo e(asset('frontend/assets/css/font-awesome-all.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/flaticon.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/owl.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/bootstrap.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/jquery.fancybox.min.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/animate.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/jquery-ui.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/nice-select.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/color/theme-color.css')); ?>" id="jssDefault" rel="stylesheet">
<link href="<?php echo e(asset('frontend/assets/css/switcher-style.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <?php echo $__env->make('frontend.home.preload', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <!-- Mobile Menu  -->
        <?php echo $__env->make('frontend.home.mobile_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php echo $__env->yieldContent('main'); ?>


        <!-- main-footer -->
        <?php echo $__env->make('frontend.home.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- main-footer end -->
    ...
    <script src="<?php echo e(asset('frontend/assets/js/owl.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/wow.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/validation.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/jquery.fancybox.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/appear.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/scrollbar.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontend/assets/js/jQuery.style.switcher.min.js')); ?>"></script>
...
<?php /**PATH /Users/aurabhattacharyya/Documents/localhost/xamppfiles/htdocs/laravelbackup/realestate/resources/views/frontend/frontend_dashboard.blade.php ENDPATH**/ ?>
