<nav class="navbar">
        ...
        $profileData = App\Models\User::find($id);
          ?>
            ...
            <li class="nav-item dropdown">
              ...
              <img class="wd-30 ht-30 rounded-circle" src="<?php echo e((!empty($profileData->photo)) ? url('upload/agent_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?>" alt="profile">
              </a>
              <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                  <div class="mb-3">
                  <img class="wd-80 ht-80 rounded-circle" src="<?php echo e((!empty($profileData->photo)) ? url('upload/agent_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?>" alt="">
                  </div>
                  <div class="text-center">
                    <p class="tx-16 fw-bolder"><?php echo e($profileData->name); ?></p>
                    <p class="tx-12 text-muted"><?php echo e($profileData->email); ?></p>
                  </div>
                </div>
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                  <a href="<?php echo e(route('agent.profile')); ?>" class="text-body ms-0">
                      <i class="me-2 icon-md" data-feather="user"></i>
                      <span>Profile</span>
                    </a>
                  </li>
                  <li class="dropdown-item py-2">
                  <a href="<?php echo e(route('agent.change.password')); ?>" class="text-body ms-0">
                  ...
                  <li class="dropdown-item py-2">
                  <a href="<?php echo e(route('agent.logout')); ?>" class="text-body ms-0">
      ...
      </nav><?php /**PATH /Users/aurabhattacharyya/Documents/localhost/xamppfiles/htdocs/laravelbackup/realestate/resources/views/agent/body/header.blade.php ENDPATH**/ ?>