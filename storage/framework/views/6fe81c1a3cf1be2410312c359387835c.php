    ...
    <div class="tabs-content">
        ...
        <div class="tab" id="tab-2">
            <div class="inner-box">
                ...
                <form action="<?php echo e(route('agent.register')); ?>" method="post" class="default-form">
                    <?php echo csrf_field(); ?>
        ...
        <!-- subscribe-section end -->
          ...
          <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aurabhattacharyya/Documents/localhost/xamppfiles/htdocs/laravelbackup/realestate/resources/views/agent/agent_login.blade.php ENDPATH**/ ?>