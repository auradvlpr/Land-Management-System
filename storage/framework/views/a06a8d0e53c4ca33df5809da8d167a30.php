...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('backend/assets/vendors/jquery-tags-input/jquery.tagsinput.min.css')); ?>">
...
<body>
  <div class="main-wrapper">
    ...
    <?php echo $__env->make('agent.body.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="page-wrapper">
     ...
     <?php echo $__env->make('agent.body.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <!-- partial -->

     <?php echo $__env->yieldContent('agent'); ?>

      <!-- partial:partials/_footer.html -->
    <?php echo $__env->make('agent.body.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <!-- partial -->
...
<script>
 ...
 <?php endif; ?> 
  ...
  <script src="<?php echo e(asset('backend/assets/js/code/code.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/assets/js/code/validate.min.js')); ?>"></script>
  ...
  <!-- Input Tags -->
  <script src="<?php echo e(asset('backend/assets/vendors/inputmask/jquery.inputmask.min.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/assets/vendors/select2/select2.min.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/assets/vendors/typeahead.js/typeahead.bundle.min.js')); ?>"></script>

  <script src="<?php echo e(asset('backend/assets/vendors/jquery-tags-input/jquery.tagsinput.min.js')); ?>"></script>

  <script src="<?php echo e(asset('backend/assets/js/inputmask.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/assets/js/select2.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/assets/js/typeahead.js')); ?>"></script>
  <script src="<?php echo e(asset('backend/assets/js/tags-input.js')); ?>"></script>

    <!-- Input Tags -->

 <!-- tinymce -->
      <script src="<?php echo e(asset('backend/assets/vendors/tinymce/tinymce.min.js')); ?>"></script>
     <script src="<?php echo e(asset('backend/assets/js/tinymce.js')); ?>"></script>
 <!-- tinymce -->


</body>
</html>    <?php /**PATH /Users/aurabhattacharyya/Documents/localhost/xamppfiles/htdocs/laravelbackup/realestate/resources/views/agent/agent_dashboard.blade.php ENDPATH**/ ?>